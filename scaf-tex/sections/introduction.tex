...
In this paper, we consider the problem of generating bijective maps, i.e. locally injective maps with \revision{non-intersecting boundaries} %no self-overlapping triangles. 
