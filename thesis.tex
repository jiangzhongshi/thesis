...
\documentclass[12pt,oneside,letterpaper, draft]{report}
...
\newcommand{\thesistitle}{Synergistic Geometry Processing:\\ from Robust Geometric Modeling to Scalable Physical Simulations}
...
% \input{prism-tex/02-Related.tex}
...
% \input{curve_meshing_in_shell_tex/02_related.tex}
...
% \input{appendix}
\input{prism-tex/11-Appendix.tex}
\chapter{Curve Meshing related}
\input{curve_meshing_in_shell_tex/90-bij-proof.tex}
\input{curve_meshing_in_shell_tex/91-app-local-ops.tex}
\input{curve_meshing_in_shell_tex/92-app-tetgen.tex}
\input{curve_meshing_in_shell_tex/93-app-tetwild.tex}
